        ...
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <Popover>
            ...
            <PopoverContent className="w-64 text-xs p-3 space-y-1.5 z-50">
              ...
              <p className="font-semibold text-foreground pt-1">Market Benchmarks</p>
              <p className="text-emerald-700 dark:text-emerald-400 font-medium">
                3% – 8% cold ATS • 15% – 25% warm / referral
              </p>
            </PopoverContent>
          </Popover>
        </CardHeader>
        ...
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <Popover>
            ...
            <PopoverContent className="w-64 text-xs p-3 space-y-1.5 z-50">
              ...
              <p className="font-semibold text-foreground pt-1">Typical Benchmark</p>
