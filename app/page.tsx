  ...
  return (
    <div className='p-4 2xl:p-6 flex flex-col items-center justify-center w-full gap-8 my-auto'>
      ...
      <div className='flex flex-col 2xl:flex-row items-center gap-4 w-full max-w-2xl'>
        <Link
          href='/applications'
          className='border-2 border-indigo-600 bg-indigo-600 text-slate-100 hover:bg-indigo-500 hover:border-indigo-500 py-2 px-4 rounded-md text-normal 2xl:text-lg transition-colors duration-300 w-full text-center'
        >
        ...
        <Link
          ...
          target='_blank'
          className='border-2 border-indigo-600 hover:bg-indigo-600 hover:text-slate-100 py-2 px-4 rounded-md text-normal 2xl:text-lg transition-colors duration-300 w-full text-center'
        >
          See How It Works
        </Link>
      </div>
